package Git::ExportDaemon::Package;
# $HeadURL: xxx/lib/Git/ExportDaemon/Package.pm $
# $Id: xxx $
...
$VERSION = "1.000";
$SUB_VERSION = "007";
$release_time = 1574592749;	## no critic (UselessNoCritic MagicNumbers)
%history = (
  'Changes' => {
    '1.000' => '1.000'
  },
  ...
  'lib/Git/ExportDaemon.pm' => {
    '1.000' => '1.000'
  },
  'lib/Git/ExportDaemon/Package.pm' => {
    '1.000' => '1.000'
  },
  'systemd-user/git-exportd.service' => {
    '1.000' => '1.000'
  },
  'systemd-user/git-exportd.socket' => {
    '1.000' => '1.000'
  },
  't/00_load.t' => {
    '1.000' => '1.000'
...
=for stopwords Git::ExportDaemon globals

=head1 NAME

Git::ExportDaemon::Package - Version and history of Git::ExportDaemon

=head1 SYNOPSIS

  use Git::ExportDaemon::Package;

  $epoch_time = Git::ExportDaemon::Package->release_time();

  $package_version = Git::ExportDaemon::Package->VERSION;

  $min_package_version = Git::ExportDaemon::Package::released($module, $module_version);
...
=item X<release_time>$epoch_time = Git::ExportDaemon::Package->release_time()
...
=item X<VERSION>$package_version = Git::ExportDaemon::Package->VERSION
...
=item X<released>$min_package_version = Git::ExportDaemon::Package::released($module, $module_version)
